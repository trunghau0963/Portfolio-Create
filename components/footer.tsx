...
export default function Footer() {
  ...
  const [portraitPosition, setPortraitPosition] = useState<"left" | "center" | "right">("right")
  ...
  useEffect(() => {
    const storedFooterPortraitVisibility = localStorage.getItem("portfolio-footer-portrait-visibility")
  ...
  useEffect(() => {
    localStorage.setItem("portfolio-footer-portrait-visibility", showPortrait.toString())
  }, [showPortrait])
    ...
    <footer className="py-16 md:py-20 lg:py-24 bg-red-600 text-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-12">
          <AnimatedSection delay={0.1}>
            <h2 className="text-white font-bold tracking-tighter leading-none">
              <EditableText initialText="LET'S WORK TOGETHER" as="span" initialFontSize={72} />
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 relative">
          ...
          {/* Content Column */}
          <div className={`${showPortrait ? "md:col-span-8 lg:col-span-9" : "md:col-span-12"} order-1 md:order-2`}>
          ...
          <div className="mt-8">
            <AnimatedSection delay={0.7}>
              <div className="flex items-center space-x-2">
                <Switch id="footer-portrait-toggle" checked={showPortrait} onCheckedChange={setShowPortrait} />
                <Label htmlFor="footer-portrait-toggle" className="flex items-center gap-2">
                  {showPortrait ? (
                    <>
